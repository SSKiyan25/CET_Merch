        ...
        <div class="py-5">
          <div class="text-center">
            <Button>
              ...
              <p class="text-primary-foreground px-4">Sign up with Google</p>
            </Button>
          </div>
          <div
              ...
              <div class="flex items-center">
                ...
                <div class="ms-3">
                  <label for="remember-me" class="text-sm dark:text-white"
                    >I accept the
                    <a
                      class="text-primary hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                      href="#"
