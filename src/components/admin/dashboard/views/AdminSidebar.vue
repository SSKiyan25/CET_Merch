<template>
  <aside
    id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-secondary border-accent border-r sm:translate-x-0"
    aria-label="Sidebar"
  >
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Pre-Orders</span>
          </a>
        </li>
      </ul>
    </div>
