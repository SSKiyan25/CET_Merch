<template>
  <footer
    class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t-2 z-50"
  >
    <!-- Grid -->
    <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
      ...
      <ul class="text-center">
        ...
        >
          <a
            class="inline-flex gap-x-2 text-sm dark:focus:outline-none dark:focus:ring-1"
            href="#"
          >
            About
          </a>
      ...
      <div class="md:text-end space-x-2">
        ...
        <a
          class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1"
          href="#"
        >
          <svg
            class="flex-shrink-0 size-3.5"
        ...
        <a
          class="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent disabled:opacity-50 disabled:pointer-events-nonedark:focus:outline-none dark:focus:ring-1"
          href="#"
        >
          <svg
            class="flex-shrink-0 size-3.5"
